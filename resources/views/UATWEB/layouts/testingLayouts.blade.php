...
<head>
    ...
    <link rel="preload" href="{{ asset('css/style.css') }}" as="style" type="text/css" crossorigin="anonymous">
    
    <!-- Bootstrap CDN (also can be deferred to improve page speed) -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet"
        integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">

    <!-- Inline critical CSS for faster initial render (can also include styles in <style> here) -->
    <style>
        :root {
            --carrotOrange: #de9228;
    ...
    <!-- Defer non-essential JS to improve page loading -->
    <script defer src="https://cdn.respond.io/webchat/widget/widget.js?cId=6850f5d54cbfd25be536b0b59847be5"></script>
...
<body>
    ...
    <!-- Cookie Consent Banner -->
    <div id="cookie-consent-banner" class="cookie-consent-banner" role="dialog" aria-labelledby="cookie-consent-heading"
    ...
    <!-- jQuery CDN (Defer to improve page speed) -->
    <script defer src="https://code.jquery.com/jquery-3.6.0.min.js"></script>

    <!-- Bootstrap JavaScript (Defer to improve page speed) -->
