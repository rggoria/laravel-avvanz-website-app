...
<head>
    ...
    <!-- Preload CSS to speed up load -->
    <link rel="preload" href="{{ asset('css/style.css') }}" as="style">

    <!-- Inline critical CSS (this will only contain the styles needed to render the initial view) -->
    <style>
        body { font-family: Arial, sans-serif; margin: 0; padding: 0; }
        h1 { color: #333; }
        /* Add any other critical CSS you need for above-the-fold content here */
    </style>
