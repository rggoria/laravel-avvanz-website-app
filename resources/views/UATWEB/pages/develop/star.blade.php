...
@section('css')
<link rel="preload" href="{{ asset('images/develop/background/developSubBg1.webp') }}" as="image">

<style>
    .bg-image-2 {
        background: url("../images/develop/background/developSubBg1.webp") no-repeat center;
