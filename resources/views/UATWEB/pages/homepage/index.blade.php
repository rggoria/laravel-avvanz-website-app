...
<div id="skeleton" class="container my-5">
    <div class="row">
        <div class="col-md-6">
            <div class="loading-placeholder mb-4"></div>
            <div class="loading-placeholder mb-4"></div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 order-2 order-md-1">
                    <div class="text-white">
                        ...
                        <p>
                            Avvanz is a multi-award winning HRTech and FinTech company that helps more than 3000 companies...
                        </p>
                ...
                <div class="col-md-6 order-1 order-md-2 justify-content-center align-content-center text-center">
                    <picture>
                        ...
                        <img src="{{ asset('images/homepage/homepage1.jpg') }}" alt="Homepage Image 1" class="img-fluid transition-up" loading="lazy">
                    </picture>
                </div>
            </div>
        </div>
