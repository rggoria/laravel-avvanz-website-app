        ...
        <div class="row">
            <div class="col-md-6 order-2 order-md-1 justify-content-center align-content-center">
                <div class="text-white">
                    <h1 class="fw-bolder display-5" id="section-heading">
            ...
            <div class="col-md-6 order-1 order-md-2 justify-content-center align-content-center text-center">
                <picture>
                    ...
                    <img src="{{ asset('images/homepage/homepage1-m.webp') }}" alt="Homepage Image 1" class="img-fluid transition-up" width="360" height="360">
                </picture>
            </div>
        </div>
    </div>
