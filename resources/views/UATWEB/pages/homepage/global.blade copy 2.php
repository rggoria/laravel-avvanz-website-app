...
<style>
    ...
    .bg-image-1::before {
        ...
        width: 100%;
        height: 100%;
        background-color: rgba(76, 95, 107, 0.3);
        z-index: 1;
    }
...
<!-- Highlights Section -->
@if($currentRouteName === 'global-usa')
    <section class="container my-5">
        <h1 class="text-center text-dmb display-5 fw-bolder">
            Highlights
        </h1>
                ...
                <div class="card border-0 h-100 text-center">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="d-grid gap-2 col-6 mx-auto my-4">
                            <a href="{{ route('blogItem', 'introduction-to-us-screening-requirements') }}" class="btn btn-orange-border text-uppercase">learn more</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-md-4 col-lg-4">
                <div class="card border-0 h-100 text-center">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="d-grid gap-2 col-6 mx-auto my-4">
                            <a href="{{ route('blogItem', 'avvanz-is-awarded-as-hr-technology-company-of-the-year-2021') }}" class="btn btn-orange-border text-uppercase">learn more</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-md-4 col-lg-4">
                <div class="card border-0 h-100 text-center">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="d-grid gap-2 col-6 mx-auto my-4">                        
                            <a href="{{ route('blogItem', 'how-do-social-media-checks-compliment-background-checks') }}" class="btn btn-orange-border text-uppercase">learn more</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-4 col-lg-4">
                <div class="card border-0 h-100 text-center">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="d-grid gap-2 col-6 mx-auto my-4">
                            <a href="{{ route('blogItem', 'uk-dbs-checks') }}" class="btn btn-orange-border text-uppercase">learn more</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-md-4 col-lg-4">
                <div class="card border-0 h-100 text-center">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="d-grid gap-2 col-6 mx-auto my-4">
                            <a href="{{ route('blogItem', 'all-you-need-to-know-about-the-british-standard-for-security-screening') }}" class="btn btn-orange-border text-uppercase">learn more</a>
                        </div>
                    </div>
                </div>
            </div>
