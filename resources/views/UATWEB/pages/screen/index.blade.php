...
@section('css')
<link rel="preload" href="{{ asset('images/screen/background/screenMainBg.webp') }}" as="image">

<style>
    .bg-image-2 {
        background: url("../images/screen/background/screenMainBg.webp") no-repeat center;
