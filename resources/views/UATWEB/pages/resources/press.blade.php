...
@section('css')
<link rel="preload" href="{{ asset('images/resources/background/resourcesSubBg5.webp') }}" as="image">

<style>
    .bg-image-2 {
        background: url("../images/resources/background/resourcesSubBg5.webp") no-repeat center;
...
<section class="container margin-vertical">
    ...
    {{ $pressItems->links('UATWEB.partials.paginate') }}
</section>
