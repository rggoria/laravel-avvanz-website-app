...
@section('css')
<link rel="preload" href="{{ asset('images/resources/background/resourcesSubBg1.webp') }}" as="image">

<style>
    .bg-image-2 {
        background: url("../images/resources/background/resourcesSubBg1.webp") no-repeat center;
