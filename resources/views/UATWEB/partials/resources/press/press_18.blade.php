...
@section('title')
Gender Parity More Than Workplace Flexibility Required - Avvanz Global
@endsection
    ...
    <div class="container padding-vertical">
        <div class="row text-white">
            <div class="col-md-7 offset-auto">
                ...
                <p>
                    <i class="fa fa-calendar"></i> March 8, 2021
                </p>
            </div>
        </div>
    </div>
...
<section class="container margin-vertical">
    <h1 class="display-5 fw-bolder">
        Gender Parity More Than Workplace Flexibility Required
    </h1>
    <p>
