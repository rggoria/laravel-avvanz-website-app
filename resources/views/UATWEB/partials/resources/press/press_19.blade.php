...
@section('title')
Avvanz Has Been Chosen And Appointed By The Ministry Of Manpower (Mom) Work Pass Division As An Approved Global Background Screening Company - Avvanz Global
@endsection
    ...
    <div class="container padding-vertical">
        <div class="row text-white">
            <div class="col-md-7 offset-auto">
                ...
                <p>
                    <i class="fa fa-calendar"></i> March 9, 2021
                </p>
            </div>
        </div>
    </div>
...
<section class="container margin-vertical">
    ...
    <p>
        For more information on our background screening services, email us at <a href="mailto:consult@avvanz.com" class="link-hover">consult@avvanz.com</a>.
    </p>
</section>
