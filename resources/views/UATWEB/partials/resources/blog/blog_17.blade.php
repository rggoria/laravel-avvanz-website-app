...
<section class="container margin-vertical">
    ...
    <p>
        Avvanz provides AFP Checks and more information can be found in this screenshot – Source: <a href="https://www.avvanz.com/screenglobal/" class="link-hover">https://www.avvanz.com/screenglobal/</a> (Avvanz’s multi-award winning Background Checking platform) 
    </p>
    ...
    <p>
        Avvanz offers International Criminal Checks covering 100+ countries as well. 
    </p>
    <p>
        <span class="fw-bolder">Financial Checks</span>: APRA may also conduct financial checks to ensure that the entity or individual has the financial capacity to meet its obligations. This may include a review of the entity’s financial statements, credit history, and other financial information.
    </p>
    <p>
        Aspects assessed – Not insolvent
    </p>
    <p>
        Avvanz offers Credit Check, Financial Regulatory Check and Bankruptcy Checks in Australia. You can obtain detailed information on Scope, Source, Turnaround Time, Cost from ScreenGlobal or you can write to <a href="mailto:consult@avvanz.com" class="link-hover">consult@avvanz.com</a>. Similarly for the below APRA related checks recommendations: 
    </p>
    <p>
        Conflicting Directorship: This is to ensure no conflict of interest, or where one exists, it should not pose a risk. 
    </p>
    <p>
        Aspects assessed – No conflict of interest
    </p>
    <p>
        Avvanz searches for past and present directorships and possibly any disqualification from directorship. 
    </p>
    <p>
        <span class="fw-bolder">Qualifications and Experience</span>: APRA may also require individuals to provide evidence of their qualifications and experience, particularly for senior management and board positions. This may include a review of the individual’s education and work history, as well as any relevant professional qualifications.
    </p>
    <p>
        Aspects assessed – Skills & Qualifications, Competence
    </p>
    <p>
        <span class="fw-bolder">Reference Checks</span> (Avvanz calls it Employment Performance Checks): APRA may conduct reference checks to verify an individual’s employment history and character. This may involve contacting previous employers or referees to confirm details of the individual’s employment history and to seek feedback on their performance and character.
    </p>
    <p>
        Aspects assessed – Honesty, Integrity and Judgement
    </p>
    ...
    <div class="d-flex justify-content-center">
        <section class="mb-4 d-flex">
            ...
            <a
                ...
                href="https://www.facebook.com/share_channel/?link=https%3A%2F%2Fwww.avvanz.com%2Fapra-checks%2F&app_id=966242223397117&source_surface=external_reshare&display&hashtag"
                target="_blank"
                role="button"
            >
            ...
            <a
                ...
                href="https://www.linkedin.com/uas/login?session_redirect=https%3A%2F%2Fwww.linkedin.com%2FshareArticle%3Fmini%3Dtrue%26url%3Dhttps%3A%2F%2Fwww.avvanz.com%2Fapra-checks%2F%26title%3DAPRA%2520Checks%2520-%2520Avvanz%2520Global%26summary%3D%26source%3Dhttps%3A%2F%2Fwww.avvanz.com%2Fapra-checks%2F"
                target="_blank"
                role="button"
            >
