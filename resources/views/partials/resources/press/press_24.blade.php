...
@section('title')
Applicants for a new employment pass must have academic qualifications from September - Avvanz Global
@endsection
...
<section class="container margin-vertical">
    <h1 class="display-5 fw-bolder">
        Applicants for a new employment pass must have academic qualifications from September
    </h1>
    <p>
        <span class="fw-bolder">April 21, 2023</span> 08:30
    </p>
    <p>
        <span class="fw-bolder">Reposted from:</span> Lianhe Zaobao
    </p>
    <p>
        <span class="fw-bolder">Article link:</span> <a href="https://finance.sina.com.cn/money/forex/forexinfo/2023-04-21/doc-imyrcanr7300733.shtml" class="link-hover">https://finance.sina.com.cn/money/forex/forexinfo/2023-04-21/doc-imyrcanr7300733.shtml</a>
    </p>
    <div class="text-start margin-vertical">
        <img class="img-fluid w-25 h-25" src="{{ asset('images/resources/pressItems/press24-1.png') }}" alt="press18-1">
    </div>
    <p>
