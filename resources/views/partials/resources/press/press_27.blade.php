...
<section class="container margin-vertical">
    ...
    <div class="text-center">
        <img class="img-fluid w-50 h-50" src="{{ asset('images/resources/pressItems/press27-1.jpg') }}" alt="press27-1">
    </div> 
    <p>
    ...
    <div class="text-center">
        <img class="img-fluid w-50 h-50" src="{{ asset('images/resources/pressItems/press27-2.jpg') }}" alt="press27-2">
    </div>
    <p>
