...
@section('title')
More companies doing background checks for employment pass applicants - Avvanz Global
@endsection
...
<section class="container margin-vertical">
    <h1 class="display-5 fw-bolder">
        More companies doing background checks for employment pass applicants
    </h1>
    <p class="text-muted">
