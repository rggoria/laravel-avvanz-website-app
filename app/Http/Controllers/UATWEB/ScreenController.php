...
class ScreenController extends Controller
{
    ...
    {
        return view('UATWEB.pages.screen.index');
    }

    public function backgroundScreening()
    {
        return view('UATWEB.pages.screen.backgroundScreening');
    }

    public function avvanzScreen()
    {
        return view('UATWEB.pages.screen.avvanzScreen');
    }
    public function backgroundCheck()
    {
        ...
        return view('UATWEB.pages.screen.backgroundCheck',[
    ...
    {
        return view('UATWEB.pages.screen.avvanzSreenGlobal');
    }

    public function process()
    {
        return view('UATWEB.pages.screen.process');
    }

    public function kyc()
    {
        return view('UATWEB.pages.screen.kyc');
    }

    public function screenChain()
    {
        return view('UATWEB.pages.screen.screenChain');
    }

    public function singaporeWork()
    {
        return view('UATWEB.pages.screen.singaporeWork');
    }
    ...
    public function companyDue()
    {
        ...
        return view('UATWEB.pages.screen.companyDue', [
            'dueDiligenceItems' => $dueDiligenceItems,
    ...
    public function partnership() {
        ...
        return view('UATWEB.pages.screen.partnership', [
